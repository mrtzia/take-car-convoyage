...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#111111] overflow-visible" style={{ zIndex: 9999 }}>
      <div className="flex items-center justify-between py-0" style={{ paddingLeft: "10px", paddingRight: "10px" }}>
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="section-inner md:hidden bg-[#111111] border-t border-white/10 py-8 flex flex-col gap-6"
          >
            {links.map((l) => (
              <a
                key={l.href}
